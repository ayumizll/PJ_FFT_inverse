# -*- coding: utf-8 -*-
# =============================================================================
# Sine model analysis and synthesis
# @author: Quentin
# Version 4.0
# =============================================================================
...
def sine_model(s,a_win,overlap_factor,N_fft_a,N_fft_s,thres):
...
#   Phase increment vector
    delta_phi = 2*alpha*np.pi*np.arange(mid_fft_a+1)*H/N_a
...
#       Interpolated values
        ...
        if (k == 0):
            ...
            arg_X_shifted += delta_phi
            arg_X_shifted = arg_X_shifted % (2*np.pi)

        peak_phase = np.interp(peak_loc_interp,np.array(range(np.size(arg_X_shifted))),arg_X_shifted)
#        peak_phase = 
#       Shift the phase
